...
class Line < GeometryValue
  ...
  def intersectLine(_line)
    if m==_line.m
      ...
      tmpx = (_line.b - b)/(m - _line.m)
      Point.new(tmpx,m*tmpx+b)
    end
  end

  def intersectVerticalLine(_vline)
    Point(_vline.x,m*_vline.x+b)
  end
  def intersectWithSegmentAsLineResult(ls)
...
class VerticalLine < GeometryValue
  ...
  def intersectPoint(_p)
    _p.intersectVerticalLine self
  end
  def intersectLine(_line)
    _line.intersectVerticalLine self
  end
